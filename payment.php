<?php
include('session.php');
if(isset($_POST['ckout'])){
  $sql = "UPDATE user_data SET Bookings='".$train_no."' WHERE User='".$user_check."' ";
      ...
      <form method = "POST" action = "#">
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="email" name="email" placeholder="Mail-Id" required>
            ...
            <input type="text" id="city" name="city" placeholder="Country" required>
        ...
        <input type="submit" value="Continue to checkout" class="btn" name="ckout">
      </form>
    </div>
  </div>
